...
bool HedgeAutoOrderGroup::CreateManulBuyOrder(double lots, string comment) {
...
bool HedgeAutoOrderGroup::CreateManulSellOrder(double lots, string comment) {
    string comm_grp = this.GetGroupComment();
...
bool HedgeAutoOrderGroup::CreateSigBuyOrder(double lots, string comment) {
    string comm_grp = this.GetGroupComment();
...
bool HedgeAutoOrderGroup::CreateSigSellOrder(double lots, string comment) {
    string comm_grp = this.GetGroupComment();
...
bool HedgeAutoOrderGroup::UpdateMagicNumbersAll() {
...
int HedgeAutoOrderGroup::UpdateMagicNumber(int mn_to_update, MN_DIR mn_dir) {
