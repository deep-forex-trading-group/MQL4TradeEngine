...
void AIRobotUI::InitGraphItems() {
    ...
    int button_inter_y=30;
    int button_length = 60;
    int button_width = 20;


    ui_utils.Button("平多按钮","平多","平多",button_x+button_inter_x*1,button_y+button_inter_y*3,
                    button_length,button_width,button_section_set_pos,clrFireBrick,clrBlack);
    ui_utils.Button("平空按钮","平空","平空",button_x+button_inter_x*0,button_y+button_inter_y*3,
                    button_length,button_width,button_section_set_pos,clrMediumVioletRed,clrBlack);
    ui_utils.Button("平盈利多按钮","平盈利多","平盈利多",button_x+button_inter_x*1,button_y+button_inter_y*2,
                    button_length,button_width,button_section_set_pos,clrMediumSeaGreen,clrBlack);
    ui_utils.Button("平盈利空按钮","平盈利空","平盈利空",button_x+button_inter_x*0,button_y+button_inter_y*2,
                    button_length,button_width,button_section_set_pos,clrChocolate,clrBlack);
    ui_utils.Button("全平按钮","全平","全平",button_x+button_inter_x*1,button_y+button_inter_y*1,
                    button_length,button_width,button_section_set_pos,clrDarkViolet,clrBlack);
    ui_utils.Button("EA开关按钮","开启EA","关闭EA",button_x+button_inter_x*0,button_y+button_inter_y*1,
                    button_length,button_width,button_section_set_pos,clrBlue,clrRed);
    ui_utils.Button("测试按钮","开启测试","关闭测试",button_x+button_inter_x*1,button_y+button_inter_y*0,
                    button_length,button_width,button_section_set_pos,clrDarkViolet,clrBlack);
